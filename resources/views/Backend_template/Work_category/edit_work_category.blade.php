    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <form  action="{{ route('work.category.update',$work_category_edits->id) }}" method="POST"  class="needs-validation" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        <label for="validationCustom01" class="form-label">Work Category Name</label>
                                        <input type="text" name="work_category_name" value="{{ $work_category_edits->work_category_name }}" class="form-control" id="validationCustom01"
                                             required >
