            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('all.banner') }}">Banner</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('all.about') }}">About Post</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('contact.all') }}">Contact Post</a></li>
                        <li><a href="{{ route('contact.add') }}">Add Contact</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            <a href="{{ route('work.category.all') }}" class="has-arrow">Work Category</a>
                        </li>
                        <li>
                            <a href="{{ route('add.work.category') }}" class="has-arrow">Add Work Category</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            <a href="{{ route('experience.category.all') }}" class="has-arrow">Experience All Category</a>
                        </li>
                        <li>
                            <a href="{{ route('add.Experience.category') }}" class="has-arrow">Add Experience Category</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            <a href="{{ route('portfolio.all') }}" class="has-arrow">All Portfolio</a>
                        </li>
                        <li>
                            <a href="{{ route('add.portfolio') }}" class="has-arrow">Add Portfolio</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            <a href="{{ route('portfolio.category.all') }}" class="has-arrow">All Portfolio Category</a>
                        </li>
                        <li>
                            <a href="{{ route('add.portfolio.category') }}" class="has-arrow">Add Portfolio Category</a>
                        </li>
                    </ul>
                </li>
